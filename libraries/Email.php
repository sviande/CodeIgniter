...
class Email
{
    ...
    public $send_multipart = true; // TRUE/FALSE - Yahoo does not like multipart alternative, so this is an override.
        ...
        switch ($this->_get_content_type()) {
            ...
            case 'html' :
                ...
                if ($this->send_multipart === false) {
                    ...
                    $body .= $this->_get_alt_message(
                        ) . $this->newline . $this->newline . "--" . $this->_alt_boundary . $this->newline;
