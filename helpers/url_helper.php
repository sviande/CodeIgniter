...
function anchor_popup($uri = '', $title = '', $attributes = false)
{
    ...
    if ($attributes === false) {
        ...
        onclick=\"window.open('" . $site_url . "', '_blank');\">" . $title . "</a>";
    }
    ...
    return "<a href='javascript:void(0);' onclick=\"window.open('" . $site_url . "', '_blank', '" .
    _parse_attributes(
        $atts,
        true
    ) . "');\"$attributes>" . $title . "</a>";
