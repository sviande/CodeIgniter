...
class Driver extends \CI\Database\ActiveRecord
{
    ...
    public function transRollback()
    {
        ...
        $this->simpleQuery('ROLLBACK TRAN');
        return true;
    }
    ...
    public function listTablesStatement($prefix_limit = false)
    {
        ...
        if ($prefix_limit !== false AND $this->dbprefix != '') {
            //$sql .= " LIKE '".$this->escapeLikeStr($this->dbPrefix)."%' ".sprintf($this->like_escape_str, $this->like_escape_chr);
